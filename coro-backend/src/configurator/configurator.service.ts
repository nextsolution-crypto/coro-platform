...
export class ConfiguratorService {
...
},
        {
          ...
          fields: [
              ...
              tooltip: 'PPNAE = Personnes Nécessitant Assistance À l\'Évacuation. Leur présence requiert des mesures spécifiques documentées et un registre à jour (CNPI 2020 art. 2.8.2.1).' },
            {
              ...
              type: 'checkbox_group',
              checkboxOptions: [
                'Mobilité réduite (fauteuil roulant, marchette)',
                'Vision',
                'Audition / communication',
                'Cognition / orientation',
                'Assistance médicale requise (perfusion, O₂, etc.)',
                'Temporaire (fracture, chirurgie récente)',
                'Autre',
              ],
            },
            {
  ...
  tooltip: 'Adressable : chaque détecteur a une adresse unique — localisation précise de l\'alarme. Zoné : détecteurs regroupés par zone — localisation approximative.' },
        ...
        {
          id: 'systemes_integres',
          title: 'Systèmes intégrés S1001',
          icon: '🔗',
          fields: [
            {
            ...
            {
              key: 's1001Coordonnateur',
              label: 'Coordonnateur des essais intégrés (nom / entreprise)',
              type: 'text',
            },
          ],
        },
