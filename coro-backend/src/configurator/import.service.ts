...

{
  ...
  "centraleSurveillance": "string (nom de la centrale de surveillance incendie ou centrale d'alarme incendie, ex: Stanley Sécurité, Securitas, ADT, Alarme Québec, Telus)",
  "centraleTelephone": "string (numéro de téléphone de la centrale de surveillance incendie ou centrale d'alarme incendie)",
