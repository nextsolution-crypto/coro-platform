        ...
        tables: [
          {
            ...
            columns: ['Catégorie', 'Zones / éléments à vérifier', 'Risque associé', 'Priorité'],
            rows: [
              { categorie: 'Accès et circulation', zones: 'Entrées principales, portes vitrées, portes coupe-feu donnant sur l\'extérieur', risque: 'Bris de verre, débris projetés, blessures', priorite: 'Élevée' },
              { categorie: 'Stationnements', zones: 'Stationnements extérieurs, accès souterrains, rampes', risque: 'Chute d\'objets, débris, perte de contrôle des véhicules', priorite: 'Élevée' },
              { categorie: 'Façades et vitrages', zones: 'Fenêtres exposées, murs rideaux, vitrines', risque: 'Bris de verre, projections vers l\'intérieur', priorite: 'Élevée' },
              { categorie: 'Zones de chute potentielle', zones: 'Balcons, corniches, marquises, auvents, enseignes', risque: 'Chute d\'éléments structuraux ou décoratifs', priorite: 'Élevée' },
              { categorie: 'Toitures et terrasses', zones: 'Terrasses accessibles, trappes de toit, équipements mécaniques visibles', risque: 'Soulèvement, infiltration, chute d\'objets', priorite: 'Élevée' },
              { categorie: 'Équipements exposés', zones: 'Mobilier extérieur, bacs, signalisation temporaire, conteneurs', risque: 'Objets projetés par le vent', priorite: 'Moyenne' },
              { categorie: 'Espaces fréquentés', zones: 'Aires communes vitrées, halls, zones d\'attente', risque: 'Blessures aux occupants', priorite: 'Moyenne' },
              { categorie: 'Zones secondaires', zones: 'Espaces peu fréquentés ou fermés au public', risque: 'Risque limité aux biens', priorite: 'Faible' },
            ],
          },
          {
            id: 'chaleur',
            procedure: 'P023',
            title: 'VAGUES DE CHALEUR',
            columns: ['Catégorie', 'Zones / éléments à vérifier', 'Risque associé', 'Priorité'],
            rows: [
              { categorie: 'Espaces intérieurs fréquentés', zones: 'Aires communes, halls d\'entrée, bureaux sans climatisation', risque: 'Stress thermique, inconfort, malaises', priorite: 'Élevée' },
              { categorie: 'Salles sans ventilation active', zones: 'Locaux techniques, zones sans fenêtres / circulation d\'air', risque: 'Accumulation de chaleur, coup de chaleur', priorite: 'Élevée' },
              { categorie: 'Systèmes CVAC / climatisation', zones: 'Unités de traitement d\'air, condenseurs, conduits, filtres', risque: 'Défaillance, surcharge, baisse de refroidissement', priorite: 'Élevée' },
              { categorie: 'Zones exposées au soleil', zones: 'Façades vitrées exposées sud / ouest, zones à effet serre', risque: 'Augmentation rapide de la température intérieure', priorite: 'Élevée' },
              { categorie: 'Occupants vulnérables', zones: 'Personnes âgées, personnes avec problèmes respiratoires / de santé', risque: 'Risque élevé d\'épuisement, déshydratation', priorite: 'Élevée' },
              { categorie: 'Stationnements et zones semi-ouvertes', zones: 'Parkings non ventilés, zones couvertes', risque: 'Accumulation de chaleur extrême, risques cardiovasculaires', priorite: 'Moyenne' },
              { categorie: 'Espaces extérieurs fréquentés', zones: 'Terrasses, zones d\'attente non ombragées', risque: 'Insolation, coup de chaleur', priorite: 'Moyenne' },
              { categorie: 'Circulation interne', zones: 'Zones de déplacement sans air conditionné (escaliers, ascenseurs)', risque: 'Effort physique + chaleur = fatigue / malaise', priorite: 'Moyenne' },
              { categorie: 'Zones secondaires peu fréquentées', zones: 'Stockage, archives, sous-sols frais', risque: 'Moindre impact immédiat', priorite: 'Faible' },
            ],
          },
          {
            id: 'inondation',
            ...
            columns: ['Catégorie', 'Zones / éléments à vérifier', 'Risque associé', 'Priorité'],
            rows: [
              { categorie: 'Sous-sols', zones: 'Accès aux sous-sols, machinerie, réseaux', risque: 'Dommages aux équipements critiques, contamination, risques électriques', priorite: 'Élevée' },
              { categorie: 'Entrées / Accès', zones: 'Entrées principales, accès piétonniers et garage', risque: 'Infiltration d\'eau, glissement de planchers, blessure', priorite: 'Élevée' },
              { categorie: 'Équipements vitaux', zones: 'Génératrices, pompes, systèmes électriques', risque: 'Courts-circuits, panne de secours', priorite: 'Élevée' },
              { categorie: 'Rives & pentes naturelles', zones: 'Zones basses / cuvettes (ex : zones inondables)', risque: 'Accumulation d\'eau rapide, submersion', priorite: 'Élevée' },
              { categorie: 'Stationnements / rampes', zones: 'Rampes souterraines, parkings exposés', risque: 'Eau stagnante, véhicules bloqués', priorite: 'Moyenne' },
              { categorie: 'Bâtiments adjacents', zones: 'Fonds de commerce, zones techniques au rez-de-chaussée', risque: 'Dégradation des installations, perte d\'accessibilité', priorite: 'Moyenne' },
              { categorie: 'Circulation & routes', zones: 'Voies locales sujettes au ruissellement', risque: 'Fermetures, perturbation des accessibilités', priorite: 'Moyenne' },
              { categorie: 'Zones secondaires', zones: 'Zones peu sujettes à accumulation directe', risque: 'Faibles risques de dommages', priorite: 'Faible' },
            ],
          },
          {
            id: 'verglas',
            ...
            columns: ['Catégorie', 'Zones / éléments à vérifier', 'Risque associé', 'Priorité'],
            rows: [
              { categorie: 'Toitures & structures hautes', zones: 'Toits plats, bardeaux, corniches', risque: 'Chute de glace, infiltration d\'eau', priorite: 'Élevée' },
              { categorie: 'Branches & arbres', zones: 'Arbres bordant bâtiments/routes', risque: 'Chute de branches lourdes, pannes', priorite: 'Élevée' },
              { categorie: 'Lignes électriques & poteaux', zones: 'Réseaux aériens', risque: 'Rupture sous glace / panne', priorite: 'Élevée' },
              { categorie: 'Trottoirs & accès piétons', zones: 'Marche, abords d\'entrée', risque: 'Glissades, chutes sur glace', priorite: 'Élevée' },
              { categorie: 'Routes & stationnements', zones: 'Voiries locales, rampes', risque: 'Perte d\'adhérence, collisions', priorite: 'Moyenne' },
              { categorie: 'Accès véhicules urgents', zones: 'Voies principales d\'urgence & évacuation', risque: 'Retards de secours', priorite: 'Moyenne' },
              { categorie: 'Signalisations & éclairage', zones: 'Panneaux & éclairage extérieurs', risque: 'Confusion, visibilité réduite', priorite: 'Moyenne' },
              { categorie: 'Zones moins utilisées', zones: 'Allées secondaires peu fréquentées', risque: 'Risque limité', priorite: 'Faible' },
            ],
          },
        ],
      },
        ...
        tables: [
          {
            ...
            procedure: 'P022',
            title: 'HIGH WINDS',
            columns: ['Category', 'Zones / Elements to Check', 'Associated Risk', 'Priority'],
            rows: [
              { categorie: 'Access and circulation', zones: 'Main entrances, glass doors, exterior fire doors', risque: 'Glass breakage, flying debris, injuries', priorite: 'High' },
              { categorie: 'Parking areas', zones: 'Outdoor parking, underground access, ramps', risque: 'Falling objects, debris, loss of vehicle control', priorite: 'High' },
              { categorie: 'Facades and glazing', zones: 'Exposed windows, curtain walls, storefronts', risque: 'Glass breakage, interior projections', priorite: 'High' },
              { categorie: 'Potential fall zones', zones: 'Balconies, cornices, canopies, awnings, signs', risque: 'Falling structural or decorative elements', priorite: 'High' },
              { categorie: 'Rooftops and terraces', zones: 'Accessible terraces, roof hatches, visible mechanical equipment', risque: 'Uplift, water infiltration, falling objects', priorite: 'High' },
              { categorie: 'Exposed equipment', zones: 'Outdoor furniture, bins, temporary signage, containers', risque: 'Objects projected by wind', priorite: 'Medium' },
              { categorie: 'Occupied spaces', zones: 'Glass common areas, lobbies, waiting areas', risque: 'Occupant injuries', priorite: 'Medium' },
              { categorie: 'Secondary zones', zones: 'Low-traffic or public-restricted spaces', risque: 'Risk limited to property', priorite: 'Low' },
            ],
          },
          {
            id: 'chaleur',
            ...
            columns: ['Category', 'Zones / Elements to Check', 'Associated Risk', 'Priority'],
            rows: [
              { categorie: 'Occupied interior spaces', zones: 'Common areas, lobbies, offices without air conditioning', risque: 'Heat stress, discomfort, illness', priorite: 'High' },
              { categorie: 'Rooms without active ventilation', zones: 'Technical rooms, areas without windows / air circulation', risque: 'Heat accumulation, heat stroke', priorite: 'High' },
              { categorie: 'HVAC / air conditioning systems', zones: 'Air handling units, condensers, ducts, filters', risque: 'Failure, overload, reduced cooling', priorite: 'High' },
              { categorie: 'Sun-exposed areas', zones: 'South/west glazed facades, greenhouse-effect zones', risque: 'Rapid increase in indoor temperature', priorite: 'High' },
              { categorie: 'Vulnerable occupants', zones: 'Elderly persons, persons with respiratory / health issues', risque: 'High risk of exhaustion, dehydration', priorite: 'High' },
              { categorie: 'Parking and semi-open areas', zones: 'Unventilated parking, covered areas', risque: 'Extreme heat accumulation, cardiovascular risks', priorite: 'Medium' },
              { categorie: 'Frequented outdoor spaces', zones: 'Terraces, unsheltered waiting areas', risque: 'Sunstroke, heat stroke', priorite: 'Medium' },
              { categorie: 'Internal circulation', zones: 'Movement areas without air conditioning (stairs, elevators)', risque: 'Physical exertion + heat = fatigue / illness', priorite: 'Medium' },
              { categorie: 'Low-traffic secondary zones', zones: 'Storage, archives, cool basements', risque: 'Lower immediate impact', priorite: 'Low' },
            ],
          },
          {
            id: 'inondation',
            ...
            columns: ['Category', 'Zones / Elements to Check', 'Associated Risk', 'Priority'],
            rows: [
              { categorie: 'Basements', zones: 'Basement access, machinery, networks', risque: 'Damage to critical equipment, contamination, electrical hazards', priorite: 'High' },
              { categorie: 'Entrances / Access', zones: 'Main entrances, pedestrian and garage access', risque: 'Water infiltration, floor slippage, injury', priorite: 'High' },
              { categorie: 'Vital equipment', zones: 'Generators, pumps, electrical systems', risque: 'Short circuits, backup power failure', priorite: 'High' },
              { categorie: 'Banks & natural slopes', zones: 'Low-lying areas / basins (e.g. flood-prone zones)', risque: 'Rapid water accumulation, submersion', priorite: 'High' },
              { categorie: 'Parking / ramps', zones: 'Underground ramps, exposed parking areas', risque: 'Standing water, trapped vehicles', priorite: 'Medium' },
              { categorie: 'Adjacent buildings', zones: 'Ground floor commercial / technical areas', risque: 'Installation degradation, loss of accessibility', priorite: 'Medium' },
              { categorie: 'Traffic & roads', zones: 'Local roads subject to runoff', risque: 'Closures, disruption of accessibility', priorite: 'Medium' },
              { categorie: 'Secondary zones', zones: 'Areas with low direct accumulation risk', risque: 'Low damage risk', priorite: 'Low' },
            ],
          },
          {
            id: 'verglas',
            ...
            columns: ['Category', 'Zones / Elements to Check', 'Associated Risk', 'Priority'],
            rows: [
              { categorie: 'Rooftops & high structures', zones: 'Flat roofs, shingles, cornices', risque: 'Ice fall, water infiltration', priorite: 'High' },
              { categorie: 'Branches & trees', zones: 'Trees bordering buildings/roads', risque: 'Falling heavy branches, power outages', priorite: 'High' },
              { categorie: 'Power lines & poles', zones: 'Overhead networks', risque: 'Rupture under ice / power failure', priorite: 'High' },
              { categorie: 'Sidewalks & pedestrian access', zones: 'Steps, building entrances', risque: 'Slipping, falls on ice', priorite: 'High' },
              { categorie: 'Roads & parking areas', zones: 'Local roads, ramps', risque: 'Loss of traction, collisions', priorite: 'Medium' },
              { categorie: 'Emergency vehicle access', zones: 'Main emergency & evacuation routes', risque: 'Emergency response delays', priorite: 'Medium' },
              { categorie: 'Signage & lighting', zones: 'Outdoor panels & lighting', risque: 'Confusion, reduced visibility', priorite: 'Medium' },
              { categorie: 'Less-used areas', zones: 'Secondary low-traffic pathways', risque: 'Limited risk', priorite: 'Low' },
            ],
          },
        ],
      },
