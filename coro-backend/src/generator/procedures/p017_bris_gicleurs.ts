// ============================================================
// CORO — P017 : Bris de gicleurs
// Activé si : has_sprinklers
// ============================================================
...
export const P017_BRIS_GICLEURS: ProcedureTemplate = {
  ...
  roleSections: [
    {
      ...
      steps: [
        ...
        // ── Note responsabilité coupure sectorielle ─────────
        {
          id: sid(CODE, 23),
        ...
        // ── Coordination avec entreprises spécialisées ──────
        {
          id: sid(CODE, 30),
