...
exports.generateModule8 = generateModule8;
const MESSAGES_PHONIQUES_FR = [
    {
        evenement: 'ALERTE',
...
function buildEvacuationSectors(floors) {
    const sectors = [
...
function generateModule8FR(ctx) {
    return {
        moduleNumber: 8,
...
function generateModule8EN(ctx) {
    return {
        moduleNumber: 8,
...
function generateModule8(ctx) {
    return {
        fr: generateModule8FR(ctx),
        en: generateModule8EN(ctx),
    };
}
//# sourceMappingURL=module8.templates.js.map