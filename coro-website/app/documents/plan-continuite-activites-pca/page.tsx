...
const PAGE_URL = `${SITE_URL}/documents/plan-continuite-activites-pca`;
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'CORO — Plan de Continuité des Activités (PCA)',
      },
    ],
  },
...
export default function PCAPage() {
  ...
  const jsonLd = {
    ...
    about: [
      ...
      {
        '@type': 'Thing',
        name: 'Continuité des activités',
      },
      {
        '@type': 'Thing',
        name: 'Résilience organisationnelle',
      },
    ],
    publisher: {
      '@type': 'Organization',
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background: `linear-gradient(135deg, #2C3E50 0%, ${DOC.color}CC 100%)`,
          padding: '80px 24px',
        }}
      >
      ...
      <main style={{ maxWidth: 1100, margin: '0 auto', padding: '64px 24px' }}>
            ...
            >
              <h2
                style={{
                  ...
                  marginBottom: 16,
                  paddingBottom: 12,
                  borderBottom: `2px solid ${DOC.color}`,
                }}
              >
                {s.title}
              </h2>
        ...
        >
          ...
          >
            ⚠️ Ce contenu est fourni à titre informatif. Les exigences
            réglementaires varient selon le type de bâtiment, le secteur
            d&apos;activité et la municipalité. Consultez les autorités
            compétentes pour votre situation spécifique.
          </p>
        </section>
        ...
        >
          ...
          >
            Prêt à produire votre {DOC.code} ?
          </h2>
          ...
          >
            CORO génère, structure et gère vos documents de conformité depuis
