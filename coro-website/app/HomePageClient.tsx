...
>
  ...
  >
    ...
    <div className="coro-response-card">
      <div className="coro-response-card-head">
        <div>
          <small>
            {lang === 'fr'
        ...
        <div className="coro-qr-placeholder">
          <div />
          <div />
          <div />
          <span>QR</span>
      ...
      <div className="coro-response-grid">
        {[
          {
            label:
              lang === 'fr'
      ...
      <div className="coro-response-alert">
        <span>●</span>
        <div>
          <strong>
            {lang === 'fr'
          ...
          <p>
            {lang === 'fr'
              ? "Les données opérationnelles sont générées à partir de la configuration actuelle du bâtiment."
              : 'Operational information is generated from the current building configuration.'}
          </p>
        </div>
      </div>
    </div>
