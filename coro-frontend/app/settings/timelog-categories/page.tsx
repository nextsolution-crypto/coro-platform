...
export default function TimelogCategoriesPage() {
  ...
  return (
    <AppLayout>
      ...
      {showAddForm && (
        <div
          className="rounded-md p-4 sm:p-5 mb-6"
          style={{ backgroundColor: '#FFFFFF', border: '1px solid #AED6F1' }}
        >
          <h2 className="font-semibold mb-4 text-sm" style={{ color: '#2C3E50' }}>
            Nouvelle catégorie
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              onClick={handleAdd}
              disabled={saving || !newCategory.key || !newCategory.label}
              className="w-full sm:w-auto px-4 py-2 rounded text-sm text-white font-medium disabled:opacity-50"
              style={{ backgroundColor: '#C0392B' }}
            >
      ...
      <div className="rounded-md overflow-hidden" style={{ border: '1px solid #E9ECEF' }}>
        <div className="px-4 sm:px-5 py-3" style={{ backgroundColor: '#F8F9FA', borderBottom: '1px solid #E9ECEF' }}>
            ...
            {editingId === cat.key ? (
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                <input
                  ...
                  className="flex-1 min-w-0 px-3 py-2 text-sm rounded"
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="min-w-0">
                  <p className="text-sm break-words" style={{ color: '#2C3E50' }}>
                    {cat.label}
                  </p>
                  <p className="text-xs font-mono break-all" style={{ color: '#ADB5BD' }}>
                    {cat.key}
                  </p>
                </div>
