...
export const CORRECTIVE_ACTION_PERMISSIONS = ['CORRECTIVE_ACTION_CREATE', 'CORRECTIVE_ACTION_EDIT', 'CORRECTIVE_ACTION_COMPLETE', 'CORRECTIVE_ACTION_VERIFY', 'CORRECTIVE_ACTION_CLOSE'] as const;
