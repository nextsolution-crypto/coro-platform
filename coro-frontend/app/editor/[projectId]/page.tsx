                  ...
                  availableRoles2_2={
                    language === 'fr'
                      ? (document.project.building.buildingType === 'industrial'
                          ? ROLES_INTERNES_INDUSTRIEL_FR : ROLES_INTERNES_BUREAU_FR)
                      : (document.project.building.buildingType === 'industrial'
                          ? ROLES_INTERNES_INDUSTRIEL_EN : ROLES_INTERNES_BUREAU_EN)
                  }
                  ...
                  {isEditing ? (
                    <div className="space-y-3">
                      <p className="text-xs" style={{ color: '#ADB5BD' }}>
                        {language === 'fr'
                          ? 'Mode édition — Modifiez le texte directement'
                          : 'Edit mode — Modify the text directly'}
                      </p>
                      <textarea
